...
const PatientDashboard = () => {
  ...
  console.log("QueryClient inside PatientDashboard:", queryClient);
  ...
  const app = appointments.data || [];
  const upcomingAppointments = app.filter(apt => {
  ...
  const handleSaveEdit = async (e) => {
    ...
    try {
      ...
      await fetch(`${import.meta.env.VITE_API_URL}/api/patient/appointments/${editForm.id}`, {
        method: "PUT",
        headers: {
      ...
      toast({
        title: "Update failed",
        description: "Your appointment update failed.",
        variant: "destructive"
      });
    }
  };
  ...
  const handleCancelAppointment  = async (appointmentId) => {
    ...
    try {
      const response = await fetch(`${import.meta.env.VITE_API_URL}/api/patient/appointments/${appointmentId}`, {
        method: "DELETE",
        headers: {
          "Authorization": `Bearer ${token}`,
          "Content-Type": "application/json",
      ...
      toast({
        ...
        description: "Your appointment cancellation failed.",
        variant: "destructive"
      });
    }
  };
