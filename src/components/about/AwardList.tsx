            ...
            {indices.map((index, i) => (
                <div key={index} className="p-4 border rounded-lg relative group">
                    <Badge className="bg-blue-100 text-blue-800 mb-2">
                        <InlineText id={`about-award${index}-year`} />
                    </Badge>
                    <h3 className="font-semibold text-gray-900 mb-1">
                        <InlineText id={`about-award${index}-title`} />
                    </h3>
                    <p className="text-blue-600 text-sm font-medium mb-1">
                        <InlineText id={`about-award${index}-org`} />
                    </p>
                    <p className="text-gray-700 text-sm">
                        <InlineTextarea id={`about-award${index}-description`} />
                    </p>
