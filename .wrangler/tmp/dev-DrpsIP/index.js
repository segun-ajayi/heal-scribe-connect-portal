...
// .wrangler/tmp/bundle-K0TL3n/strip-cf-connecting-ip-header.js
...
async function handleMe(request, env) {
  ...
  const user = await env.auth.prepare("SELECT * FROM users WHERE token = ?").bind(token).first();
  if (!user) {
...
// .wrangler/tmp/bundle-K0TL3n/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-K0TL3n/middleware-loader.entry.ts
